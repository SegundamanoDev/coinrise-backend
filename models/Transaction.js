...
const transactionSchema = mongoose.Schema(
  {
    ...
    paymentProof: {
      secure_url: {
        type: String,
        // Make secure_url required only for deposit and upgrade_deposit
        required: function () {
          return this.type === "deposit" || this.type === "upgrade_deposit";
        },
        default: null, // Keep default null, but required will override if function returns true
      },
      public_id: {
        type: String,
        // Make public_id required only for deposit and upgrade_deposit
        required: function () {
          return this.type === "deposit" || this.type === "upgrade_deposit";
        },
        default: null, // Keep default null, but required will override if function returns true
